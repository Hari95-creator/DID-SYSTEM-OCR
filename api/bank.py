...
#     # print(data)
#     acc_name = " " + '\n'.join(
#         [re.sub(r'Account Name\s+:', '', line) for line in data.splitlines() if 'Account Name' in line])
#     acc_no = " " + '\n'.join(
#         [re.sub(r'Account Number\s+:', '', line) for line in data.splitlines() if 'Account Number' in line])
...
#     # print(data)
#     acc_name = " " + '\n'.join(
#         [re.sub(r'^[\d \t]+|[\d \t]+$', '', line) for line in data.splitlines() if 'MRS.' in line])
#     acc_no = " " + '\n'.join(
#         [re.sub(r'ACCOUNT No.\s+:', '', line) for line in data.splitlines() if 'ACCOUNT No.' in line])
